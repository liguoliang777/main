...
import com.ngame.app.BaseKeyViewFragment;
import com.ngame.app.IndexMappingKeyEnumOrdinal;
import com.ngame.app.IndexMappingKeyEnumRes;
import com.ngame.app.IndexMappingNormalKeyEnum;
import com.ngame.app.IndexMappingSpecialKeyEnum;
import com.ngame.app.JoystickAttributeDialogActivity;
import com.ngame.app.KeyAttributeDialogActivity;
import com.ngame.app.MotionAttributeDialogActivity;
import com.ngame.app.NormalKeyViewMgrUtils;
import com.ngame.app.SpecialKeyViewMgrUtils;
import com.ngame.app.ViewDragInterface;
...
public class Cj007EditActivity extends FragmentActivity implements ViewDragInterface, View
    ...
    private static Cj007EditActivity context = null;

    public static final Cj007EditActivity getInstance() {
        return context;
    }
    ...
    protected void onCreate( Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cj007);
        ...
        if (vId == R.id.iv_arrow) {
            ...
            artDlg.setPositiveButton("确认", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    ...
                    KeyMgrUtils.sSavePrefInfo(Cj007EditActivity.this);
                    updateDragKeyView();
                    dialog.dismiss();
                    Toast.makeText(Cj007EditActivity.this, "按键设置已清空", Toast.LENGTH_LONG).show();
                }
            });
            ...
            Toast.makeText(Cj007EditActivity.this, "保存成功", Toast.LENGTH_LONG).show();
...
//            LLog.d("KeyboardEditActivity->viewClick R.id.tv_motion is not realize");
    ...
    class PagerkeyAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            ((BaseKeyViewFragment) result).setViewDragInterface(Cj007EditActivity.this);
