...
public class ReportPostClient extends PostMsgBaseClient<NormalDataBean> {
    ReportPostBodyBean bean;

    public ReportPostClient(Context cxt, ReportPostBodyBean bean) {
        super(cxt);
        this.bean = bean;
    }
    ...
    protected Observable<NormalDataBean> requestService(GameService askDoctorService) {
        return askDoctorService.reportPost(HostDebug.AppJson, bean);
    }
}
